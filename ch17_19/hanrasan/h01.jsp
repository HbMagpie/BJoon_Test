				...
				<tr>
					<td bgcolor="#FFFFCC">
						<table border="1" cellspacing="0" cellpadding="2" width="600">
							<tr bgcolor="#996600">
								<td align="center" colspan="3"><font color="#FFFFFF"><b>회원 가입[한라산]</b></font></td>
							</tr>
							<tr>
								<td width="20%">아이디</td>
								<td width="50%">
							...
							<tr>
								<td>취미</td>
								<td>인터넷<input type="checkbox" name="hobb" value="인터넷">
									...
									운동<input  type="checkbox" name="hobb" value="운동">
								</td>
								<td>취미를 선택 하세요.</td>
							</tr>
							<tr>
