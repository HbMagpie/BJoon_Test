...
<%
    ...
    String usid = gBean.getUsid();
    String uspw = gBean.getUspw();
	String name = gBean.getName();
	String addr = gBean.getAddr();
					...
					<td align="center" valign="middle" bgcolor="#FFFFCC">
						<table border="1" cellpadding="2" align="center" width="600">
							<tr align="center" bgcolor="#996600">
								<td colspan="3"><font color="#FFFFFF"><b>회원 수정2</b></font></td>
							</tr>
							<tr>
								<td width="20%">아이디</td>
							...
							<tr>
								...
								<input type="button" value="자료삭제" onClick="location.href='delete.jsp?numb=<%=numb%>'"> &nbsp; &nbsp;
								<input type="button" value="신규회원" onClick="location.href='member.jsp'"></td>
						</tr>
						</table>
					</td>
				</tr>
