...
<div align="center">
	<br/>
	<h2 style="color: #FFFFFF;">JSPBoard</h2>
	<br/>
	<table align="center" width="600">
			<tr>
				<td><font color="#FFFFFF">Total : <%=totalRecord%>Articles</font><font color="pink">
			...
			<%
   				  ...
   				  if(totalPage !=0){
    			  	if (nowBlock > 1) {%>
     					...
     					<%if(pageStart==nowPage) {%><font color="pink"> <%}%>
     					[<%=pageStart %>] 
				...
				<td align="right">
					<a href="post.jsp" style="color: #FFFFFF">[글쓰기]</a> 
					<a href="javascript:list()" style="color: #FFFFFF">[처음으로]</a>
				</td>
			</tr>
		</table>
	<hr width="600"/>
