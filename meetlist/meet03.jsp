...
<%
    ...
    Bean_Meet  bBean = moimMgr.getMeet(numb);       //코드자료 가져오기

    if (request.getParameter("pass") != null) {
		String inPass = request.getParameter("pass");
		String dbPass = adminBean.getUspw();
		if (inPass.equals(dbPass)) {
			moimMgr.deleteMeet(numb);
			String url = "meet02.jsp";
...
<body bgcolor="#FFFFFF">
	<div align="center">
		...
		<form name="delFrm" method="post" action="meet03.jsp">
				...
				<tr>
					<td align="center">
						<table>
							...
							<tr>
								<td>관리자 아이디</td>
								<td><%=bBean.getT_usid()%></td>
							</tr>
							<tr>
								<td>모임 식별번호</td>
								<td><%=bBean.getT_m_code()%></td>
							</tr>
							<tr>
								<td>명산 식별번호</td>
								<td><%=bBean.getT_s_code()%></td>
							</tr>
							<tr>
								<td>등산일자</td>
								<td><%=bBean.getT_m_date()%></td>
							</tr>
							<tr>
								<td>산행내역</td>
								<td><%=bBean.getT_m_bigo()%></td>
							</tr>
							<tr>
								<td align="center">
